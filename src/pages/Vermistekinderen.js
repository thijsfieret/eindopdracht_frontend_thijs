...
function Vermistekinderen() {
    ...
    const getAllVermistekinderen = async () => {
        const api = await fetch('https://cors-anywhere.herokuapp.com/api.politie.nl/v4/vermist/vermistekinderen?language=nl&lat=52.3702157&lon=4.8951679&radius=25.0&maxnumberofitems=25&offset=0');
    ...
    return (
        <div className={styles.vermistekinderendiv}>
            <Search/>
            <h1 className={styles.vermistekinderentitel}>Alle vermiste kinderen</h1>
